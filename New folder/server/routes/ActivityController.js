...
module.exports = function (app, express) {
    ...
    Router.post('/selfActivity', function (req, res) {
        ...
        var getActivityData = function (cb) {
            ...
            // (a : User {username : "seller2"})-[p : POSTS]-(posts)-[nt : Notification {notificationType : 6}]-(b : User)
            ...
            dbneo4j.cypher({
                ...
                if (e) {
                    ...
                    dbneo4j.cypher({ query: followRequestCount }, function (err, data) {
                        if (err) {
                            ...
                            d.forEach(function (element) {
                                if (element.notificationType !== null) {
                                    ...
                                    // delete element.notificationMessage;
                                    // delete element.memberIsPrivate;
                                    // delete element.createdOn;
                                    // delete element.notificationType;
                                    // delete element.seenStatus;
                                    // delete element.postId;
                                    // delete element.thumbnailImageUrl;
                                    // delete element.followRequestStatus;
                                    // delete element.memberProfilePicUrl;
                                    // d.pop();
                                }
                            }, this);
                            responseObj = {
