...
module.exports = function (app, express) {
    ...
    Router.post('/profile/:member', function (req, res) {
        ...
        var findMemberProfileQuery = "MATCH (node: User {username : '" + username + "'}), (node2 : User {username : '" + membername + "'}) " +
            ...
            "node2.fullName AS fullName, node2.website AS websiteUrl, node2.bio AS bio, node2.place AS memberAddress, node2.latitude AS  memberLatitude, node2.longitude AS memberLongitude, " +
            ...
            "WITH memberID, fullName, websiteUrl, bio, memberEmail, memberFacebookID, phoneNumber, " +
            ...
            "WITH COUNT(f1) AS following, memberID, fullName, websiteUrl, bio, memberEmail, memberFacebookID, phoneNumber, " +
            "totalPosts, profilePicUrl, followsFlag, privateMember, privateUser, userFollowRequestStatus, " +
            ...
            "RETURN DISTINCT COUNT(f2) AS followers, following, memberID, fullName, websiteUrl, bio, memberEmail, memberFacebookID, phoneNumber, " +
            "totalPosts, profilePicUrl, followsFlag, privateMember, privateUser, userFollowRequestStatus, " +
            "memberFollowRequestStatus, businessProfile, businessName, aboutBusiness, memberAddress, memberLatitude, memberLongitude ;";
