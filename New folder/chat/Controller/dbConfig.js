...
var logger = require('./einstonLogs.js');   //import einstonLogs for logs generation
...
//     host: 'localhost:9200', //104.236.32.23
//     log: 'info'
// });
    ...
    switch (name) {
        ...
        default: return fs.appendFile("errLogs.txt", "System Error", Messages.WRONG_DB + name, function (err, data) {
            if (err) {
                ...
                logger.loggerError(Messages.UNKNOWN_ERROR);

            } else {
                logger.loggerInfo(Messages.DB_CONNECTED);
